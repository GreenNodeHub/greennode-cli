# access outbound-auth static delete
...
```text
grn agentbase access outbound-auth static delete <name>
```
...
```bash
grn agentbase access outbound-auth static delete my-apikey-provider
```
